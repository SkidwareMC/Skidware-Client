...
void CIntelligentMappings::init(Version ver) {
	if (ver == ONE_TWELVE_TWO) {
		...
		CIntelligentMappedField motionXField = make_field("posX", "D",
			"field_70165_t", "p", "D", "D");
		CIntelligentMappedField motionYField = make_field("posY", "D",
			"field_70163_u", "q", "D", "D");
		CIntelligentMappedField motionZField = make_field("posZ", "D",
			"field_70161_v", "r", "D", "D");		
		
		CIntelligentMappedField posXField = make_field("motionX", "D",
			"field_70159_w", "s", "D", "D");
		CIntelligentMappedField posYField = make_field("motionY", "D",
			"field_70181_x", "t", "D", "D");
		CIntelligentMappedField posZField = make_field("motionZ", "D",
			"field_70179_y", "u", "D", "D");
		...
		CIntelligentMappedClass playerKlass = make_klass("net.minecraft.client.entity.EntityPlayerSP",
			"net.minecraft.client.entity.EntityPlayerSP", "bud", std::vector({ onGroundField, moveForwardField,
				moveStrafingField, headRotationYawField, fallDistanceField, posXField, posYField, posZField, inWaterField, speedInAirField, rotationPitchField, motionXField, motionYField, motionZField, hurttimeField, rotationYawField, movementInputField, theWorldField}),
		...
		CIntelligentMappedMethod isKeyDownMethod = make_method("isKeyDown", "()Z",
			"func_151470_d", "e", "()Z", "()Z");
		CIntelligentMappedMethod setKeyBindStateMethod = make_method("setKeyBindState", "(IZ)V", "func_74510_a", "a", "(IZ)V", "(IZ)V");
		CIntelligentMappedClass keyBindingKlass = make_klass("net.minecraft.client.settings.KeyBinding",
			"net.minecraft.client.settings.KeyBinding", "bhy", std::vector({ pressedField, keyCodeField }), std::vector({ isKeyDownMethod, setKeyBindStateMethod }));
		...
		CIntelligentMappedField keyBindSprintField = make_field("keyBindSprint", "Lnet / minecraft / client / settings / KeyBinding; ",
			"field_151444_V", "Z", "Lnet/minecraft/client/settings/KeyBinding;", "Lbhy;");
		...
		CIntelligentMappedClass gameSettingsKlass = make_klass("net.minecraft.client.settings.GameSettings",
			"net.minecraft.client.settings.GameSettings", "bid", std::vector({ keyBindForwardField, keyBindBackField,
				keyBindLeftField, keyBindRightField, keyBindJumpField,keyBindSprintField, keyBindSneakField, gammaSettingField }), std::vector({ nullMethod }));
	...
	// Readd comments because yes
		...
		CIntelligentMappedField moveForwardField = make_field("moveForward", "F",
			"field_70701_bs", "ba", "F", "F");
		CIntelligentMappedField moveStrafingField = make_field("moveStrafing", "F",
			"field_70702_br", "aZ", "F", "F");

		CIntelligentMappedField headRotationYawField = make_field("headRotationYaw", "F",
			"field_70759_as", "aK", "F", "F");

		CIntelligentMappedField rotationYawField = make_field("rotationYaw", "F", "field_70177_z", "y", "F", "F");
		CIntelligentMappedField rotationPitchField = make_field("rotationPitch", "F", "field_70125_A", "x", "F", "F");
		...
		CIntelligentMappedField theWorldField = make_field("world", "Lnet/minecraft/client/multiplayer/WorldClient;",
			"field_70170_p", "o", "Lbsb;", "Lnet/minecraft/client/multiplayer/WorldClient;");

		CIntelligentMappedField movementInputField = make_field("movementInput", "Lnet/minecraft/util/MovementInput;",
			"field_71158_b", "b", "Lnet/minecraft/util/MovementInput;", "Lbub;");

		CIntelligentMappedField inWaterField = make_field("inWater", "Z", "field_70171_ac", "Y", "Z", "Z");

		CIntelligentMappedMethod jumpMethod = make_method("jump", "()V",
			"func_70664_aZ", "bF", "()V", "()V");

		CIntelligentMappedField hurttimeField = make_field("hurttime", "I", "field_70737_aN", "au", "I", "I");

		CIntelligentMappedField speedInAirField = make_field("speedInAir", "F", "field_71102_ce", "bF", "F", "F");

		CIntelligentMappedField fallDistanceField = make_field("fallDistance", "F", "field_70143_R", "O", "F", "F");

		CIntelligentMappedMethod setSprintMethod = make_method("setSprint", "(Z)V", "func_70031_b", "d", "(Z)V", "(Z)V");
		...
		CIntelligentMappedMethod nullmethod = make_method("(null)", "(null)",
			"(null)", "(null)", "x.x", "Default string");
		CIntelligentMappedField tickLengthField = make_field("timerSpeed", "F",
			"field_74278_d", "d", "F", "F");
		CIntelligentMappedClass timerKlass = make_klass("net.minecraft.util.Timer",
			"net.minecraft.util.Timer", "bif", std::vector({ tickLengthField }), std::vector({ nullmethod }));
		_klasses.push_back(timerKlass);
		...
		CIntelligentMappedField bossColorModifierPrevField = make_field("bossColorModifierPrev", "F",
			"field_82832_V", "A", "F", "F");
		CIntelligentMappedClass entityRendererKlass = make_klass("net.minecraft.client.renderer.EntityRenderer",
			"net.minecraft.client.renderer.EntityRenderer", "bfk", std::vector({ bossColorModifierPrevField }), std::vector({ setupOverlayRenderingMethod }));
		_klasses.push_back(entityRendererKlass);
